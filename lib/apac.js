  ...
  */
  ...
  exports.getApaclist = function(conf, JANS, cb) {
    ...
    return opHelper.execute('ItemLookup', {
      ...
      var i, items, key, result, v, valid, _i, _j, _len, _len1, _ref, _ref1, _ref10, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
      ...
      if (valid === 'True') {
        ...
        for (i = _i = 0, _len = _ref2.length; _i < _len; i = ++_i) {
          ...
          items[i] = {
            ...
            "new": (_ref6 = result.OfferSummary) != null ? (_ref7 = _ref6.LowestNewPrice) != null ? _ref7.Amount : void 0 : void 0,
            old: (_ref8 = result.OfferSummary) != null ? (_ref9 = _ref8.LowestUsedPrice) != null ? _ref9.Amount : void 0 : void 0,
            rank: result.SalesRank
          };
          _ref10 = ['new', 'old', 'rank'];
          for (_j = 0, _len1 = _ref10.length; _j < _len1; _j++) {
            key = _ref10[_j];
            items[i][key] = (v = items[i][key]) != null ? Number(v) : 0;
          }
        }
        return cb(err, items);
      } else {
