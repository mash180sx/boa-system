...
(function() {
  var AmazonManager, Sync, amaMan, conf, options;
  ...
  options = {
    debug: 1,
    proxy: 'proxy.toshiba.co.jp:8080'
  };

  amaMan = new AmazonManager(options, function(err, am) {
    return Sync(function() {
      var marketplaceID, result;
