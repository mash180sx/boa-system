...
(function() {
  var AmazonManager, EventEmitter, phantom,
    ...
    function AmazonManager(options, cb) {
      ...
      this.methods = {
        ...
        'add': function() {
          ...
          _this.premium = _this.args.premium != null ? _this.args.premium : 5;
      ...
      opts = phantom.create(function(ph) {
        _this.phantom = ph;
